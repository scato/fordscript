...
Attributions:
  - JavaScript syntax files were copied from jsfax (https://github.com/zefhemel/jsfax)
...
FordScript adds type hinting and class definitions to JavaScript. The result is converted back to JavaScript using Stratego/J. The "augment" keyword is added for type augmentation (see Crockford).
